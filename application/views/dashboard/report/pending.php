                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item"><a href="<?php echo base_url(); ?>dashboard/report/upload/pending"><?php echo $title; ?></a></div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="<?php echo base_url(); ?>report_pending_upload/download_excel" class="btn btn-icon icon-left btn-primary"><i class="fas fa-file-excel"></i> Unduh Laporan Excel</a>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="reportPendingTable">
